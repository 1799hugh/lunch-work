...
SECRET_KEY = 'django-insecure-9@64m54*jc6r0(+=)qygg&vc+t(tltipf3tf%#%bry*mpvvl8d'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # 新增這一行
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # 確保這裡包含你的模板目錄
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # 新增這一行
